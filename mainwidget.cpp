...
QMatrix4x4 & MainWidget::getOrthoProjectionMatrix()
{
...
QMatrix4x4 & MainWidget::getPerspectiveProjectionMatrix()
{
...
QMatrix4x4 & MainWidget::getViewMatrix()
{
    return viewMatrix;
}
...
void MainWidget::OnFinishedChildThread()
{
